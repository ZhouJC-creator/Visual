...
model_weight = "PlantPathology_26_0.92581.bin"
imgName = "rust01.jpg"
...
logits, att_mat, crop_imgs, heads_select_index, itemindex = model(x)

heads_select_index = heads_select_index[0]
...
for i in range(12):
    ...
    head_select_index = heads_select_index[i]
    # 遍历 select_index 并高亮对应的块
    for _, index in enumerate(head_select_index):
    ...
    # 如果需要保存高亮后的图片
    highlighted_img.convert("RGB").save(f"./output/DA/{dataset_name}/{imgName}_select_head{i}.jpg")
