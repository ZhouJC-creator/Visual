...
model_weight = "ip_102_29_0.75674.bin"
...
# **2. 设置图片文件夹路径**
image_root = "./class_imgs/ip_102"  # 图片文件夹路径
...
plt.xticks([])
plt.yticks([])
plt.title(f"交叉熵损失t-SNE图")

# **8. 保存图像**
output_dir = f"./output/{model_name}/t-SNE/{dataset_name}"
os.makedirs(output_dir, exist_ok=True)
plt.savefig(os.path.join(output_dir, f"{model_name}_t-SNE_ip102.jpg"), dpi=900, bbox_inches='tight')
