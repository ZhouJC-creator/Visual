...
from Models.ViT_DMFF.models.modeling import VisionTransformer, CONFIGS
...
aa = torch.load(model_pkl, map_location="cpu")
...
for i, v in enumerate(joint_attentions):
    ...
    # Save overlay images
    plt.imsave(f"./output/{model_name}/heatmap/{dataset_name}/{imgName.split('.')[0]}_heatmap_layer_{i + 1}.jpg",
               overlay_rgb)  # Save overlay as RGB
