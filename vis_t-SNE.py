...
model_weight = "AppleLeaf9_20_0.99279.bin"
...
plt.xticks([])
plt.yticks([])
# plt.title(f"t-SNE Visualization of SoftTriple Loss on Dataset AppleLeaf9")
plt.title(f"SoftTriple Loss 在 AppleLeaf9 数据集上的t-SNE图")

# **8. 保存图像**
output_dir = f"./output/{model_name}/t-SNE/{dataset_name}"
os.makedirs(output_dir, exist_ok=True)
plt.savefig(os.path.join(output_dir, f"{model_name}_t-SNE.jpg"), dpi=900, bbox_inches='tight')
