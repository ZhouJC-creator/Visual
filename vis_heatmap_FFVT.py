...
from Models.FFVT.models.modeling import VisionTransformer, CONFIGS

config = CONFIGS["ViT-B_16"]

datasets_name = ["AgriculturalDisease", "AppleLeaf9", "CUB", "PlantPathology", "RiceLeaf"]
datasets_class = [61, 9, 200, 12, 9]
dataset_name = datasets_name[2]
num_classes = datasets_class[2]
model_name = "FFVT"
model_weight = "CUB_22_0.91174.bin"
imgName = "Sooty_Albatross_0071_1116.jpg"

model = VisionTransformer(config, img_size=448, num_classes=num_classes,vis=True)
